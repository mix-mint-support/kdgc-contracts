...
contract KDGC is Ownable, KIP17Full("Klay Doomsday Girls Club", "KDGC"), KIP17Mintable, KIP17Pausable {

    event SetBaseURI(string baseURI);

    string public baseURI = "https://kdgc-api.com/nft/";
    ...
    function massMint(address to, uint256 start, uint256 end) external onlyMinter {
